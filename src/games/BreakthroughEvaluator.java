...
import static games.BreakthroughNoTranspositionsBoard.BLACK_PIECE;
import static games.BreakthroughNoTranspositionsBoard.WHITE_PIECE;

//currently only works for 8x8 boards
public class BreakthroughEvaluator extends StaticEvaluator {
    ...
    public Evaluation staticEval(Board boardToEvaluate) {
        BreakthroughNoTranspositionsBoard board = (BreakthroughNoTranspositionsBoard) boardToEvaluate;
    ...
    public String toString() {
        String result = "BreakthroughEvaluator (static)";
        return result;
    }
