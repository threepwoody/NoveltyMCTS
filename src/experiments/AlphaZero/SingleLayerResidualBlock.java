...
public class SingleLayerResidualBlock extends AbstractBlock {

    private static final byte VERSION = 2;

    public ParallelBlock block;

    public SingleLayerResidualBlock(int numChannels, boolean use1x1Conv, Shape strideShape) {
        super(VERSION);
        ...
        block = addChildBlock("singleLayerResidualBlock", new ParallelBlock(
                list -> {
